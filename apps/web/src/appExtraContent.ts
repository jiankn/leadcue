...
const en = {
  ...
  common: {
    ...
    messages: {
      ...
      selectLeadBeforeHandoff: "Select at least one lead before updating handoff status.",
      handoffUpdated: "Updated __COUNT__ leads to __STATUS__.",
      handoffUpdateFailed: "Handoff status update failed.",
  ...
  exportHistory: {
    ...
    markOutreachQueued: "Move to outreach",
...
const zh: AppUiExtra = {
  ...
  common: {
    ...
    messages: {
      ...
      selectLeadBeforeHandoff: "请先选择至少一条线索再更新交接状态。",
      handoffUpdated: "已将 __COUNT__ 条线索更新为：__STATUS__。",
      handoffUpdateFailed: "交接状态更新失败。",
